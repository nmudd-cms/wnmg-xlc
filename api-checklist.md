...
- [ ] API documentation is intuitive, simple, and up-to-date. Showing all API endpoints, complete with authentication details, is the standard with many APIs also providing interactive documentation using formats like [Swagger](http://swagger.io/) or API Blueprint from [Apiary.io](http://apiary.io).
